...
class TeammateManager:
    ...
    def _teammate_loop(self, name: str, role: str, prompt: str):
        system_prompt = (
            f"你是 agent team 中的固定队友，名叫{name}，职责是{role}。\n"
            f"当前目录：{Path.cwd()}。\n"
            "你是 agent team 的持久成员，不是一次性代理。\n"
...
TOOLS = [
    ...
    },
    {
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "prompt": {"type": "string", "description": "交给该队友的第一个任务"},
            },
    ...
    {
        "name": "read_inbox",
        "description": "读取并清空 lead 自己的 inbox，用于查看队友回复。",
        "input_schema": {"type": "object", "properties": {}},
    },
    {
        "name": "broadcast",
